    ...
    // ob_start();
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($date && $people && $describe)) {
                echo "Enter all the details";
            }
            else {
                $stmt1 = $conn->prepare("INSERT INTO reserve (u_id, reservetime, people, description, approval) VALUES (?, ?, ?, ?, ?)");
                $stmt1->bindParam(1, $_SESSION['u_id']);
                $stmt1->bindParam(2, $date);
                $stmt1->bindParam(3, $people);
                $stmt1->bindParam(4, $describe);
                $stmt1->bindParam(5, $nul);
                $stmt1->execute();
                echo "<script>
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" name="describe" placeholder="Special Request" id="message" style="height: 100px"></textarea>
